...
EVT_VMBUS_CHANNEL_OPENED WinapiEvtChannelOpened;
EVT_VMBUS_CHANNEL_CLOSED WinapiEvtChannelClosed;
EVT_VMBUS_CHANNEL_PACKET_RECEIVED WinapiEvtChannelPacketReceived;
...
)
{
    ...
    channelInterface.ChannelOpened = WinapiEvtChannelOpened;
    channelInterface.ChannelClosed = WinapiEvtChannelClosed;
    channelInterface.PacketReceived = WinapiEvtChannelPacketReceived;
